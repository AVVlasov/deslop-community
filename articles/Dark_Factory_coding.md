...
Харнес, с которого я снял всю проектную специфику и выложил в открытый код, называется [bro-coding-factory](https://github.com/AVVlasov/bro-coding-factory). Там цикл, гейты, судья, триггеры и память. Бери, подключай свой агент-бэкенд, настраивай под свой стек.
